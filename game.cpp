...
namespace game {
	...
	void Game::Update(GLFWwindow* window) {
		...
		*/
		...
		if (game->input_m == true || game->input_m1 == true) {
			CreateMissileInstance("missile", "MissileParticle", "MissileMaterial");
		}
	...
	void Game::SetupEnemies() {
		...
		for (int i = 0; i < 0; i++) {
			...
			Enemy* bad_tank;
			setupTank(i, &bad_tank);

			bad_tank->SetPosition(glm::vec3(30.0, 0.0, 30.0));
	...
	void Game::setupTank(int tankNumber, Enemy** enemy)
	{
		std::stringstream ss;
		ss << tankNumber;
		std::string index = ss.str();

		*enemy = CreateTexturedEnmeyTank("enemyTank" + index, "CylinderMesh", "textureMaterial", "Root", "Camo");
		(*enemy)->SetScale(glm::vec3(0.1, 0.1, 0.1));
		SceneNode* enemyBody = CreateTexturedInstance("enemyTankBody" + index, "CubeMesh", "textureMaterial", "enemyTank" + index, "Camo");
		enemyBody->SetScale(glm::vec3(3.0, 2.5, 4.0));
		enemyBody->SetPosition(glm::vec3(0.0, 1.75, 0.0));

		SceneNode* enemyBodyTop = CreateTexturedInstance("enemyTankTop" + index, "CubeMesh", "textureMaterial", "enemyTankBody" + index, "Camo");
		enemyBody->SetScale(glm::vec3(30.0, 30.5, 30.0));
		enemyBody->SetPosition(glm::vec3(0.0, 1.75 + 0.75, 0.0));




		SceneNode* enemyWheel1 = CreateTexturedInstance("enemyWheel1" + index, "CylinderMesh", "textureMaterial", "enemyTankBody" + index, "Camo");
		enemyWheel1->SetScale(glm::vec3(2.0, 2.0, 1.8));
		enemyWheel1->Rotate(glm::angleAxis(3.141519f / 2.0f, glm::vec3(0.0, 1.0, 0.0)));
		enemyWheel1->SetPosition(glm::vec3(0.0, -0.25, 1.25));

		SceneNode* enemyWheel2 = CreateTexturedInstance("enemyWheel1" + index, "CylinderMesh", "textureMaterial", "enemyTankBody" + index, "Camo");
		enemyWheel2->SetScale(glm::vec3(2.0, 2.0, 1.8));
		enemyWheel2->Rotate(glm::angleAxis(3.141519f / 2.0f, glm::vec3(0.0, 1.0, 0.0)));
		enemyWheel2->SetPosition(glm::vec3(0.0, -0.25, -1.25));
